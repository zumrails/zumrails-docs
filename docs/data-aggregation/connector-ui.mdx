...
The connector URL is a URL you can simply host on your website or send by email. No specific integration is required to let your clients to link their card.
