...
The connector URL is an URL you can simply host on your website or send by email. No specific integration is required to let your clients to link their card. This connector UI is used if your use case is just aggregation. If you want to use aggregation with payments, this is a different flow and you need to use the Url from the portal under Integration Codes >> Add Payment Profile.
