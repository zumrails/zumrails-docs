...
This option is used with institutions that prompt SMS or Email verification, when they give a list of phones and a list options (SMS/Phone Call/Email) to send the verification code.
