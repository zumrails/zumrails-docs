...
:::note
 The accountselector parameter will always be set to "True" by default. To set the Parameter "accountselector" to "False", it is mandatory to specify the parameter adduserinportal = false.
:::
