...
window.addEventListener('message', function(e) {
    ...
    var data = e.data;
    if (data && data.origin && data.origin === 'ZUM_RAILS_IFRAME') {
        console.log(data);
    }
});
</script>
...
> Invoice checkout event (only EFT)
{
  "origin": "ZUM_RAILS_IFRAME",
  "UserId": "c18dd952-...-9bd6a46eb1c4",
}
...
> Subscription checkout event (only EFT)
{
  "origin": "ZUM_RAILS_IFRAME",
  "UserId": "c18dd952-...-9bd6a46eb1c4",
}
