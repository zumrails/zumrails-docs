...
isError | true/false to indicate if the request was successfullly processed
...
Follow these steps to quickly get started with the Zũm Rails API:

Once you have access to your sandbox portal:

1) Login in your sandbox portal, navigate to Settings -> Technical Information -> API Settings. Grab your api username and password

2) Download and install the Postman app

3) Install the Zũm Rails Postman Collection. Click the "Run in Postman" button below to install

4) In Postman find the endpoint /Authorize, paste your api username and password and it's all set.

[![Run in Postman](https://run.pstmn.io/button.svg)](https://app.getpostman.com/run-collection/a1cc1a6719657ef29b66?action=collection%2Fimport)
