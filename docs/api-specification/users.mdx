...
For more information about Zūm Connect, [click here](../ways-to-integrate/zum-connect).
...
Parameter               | Type      | Credit Card (Mandatory)  | Visa Direct (Mandatory)   | Description
---------               | -------   | ----          | ----          | ----
AddressLine1            | string    | no           | yes           | shipping address line 1
AddressLine2            | string    | no           | yes           | shipping address line 2
AddressPostalCode       | string    | no           | yes           | shipping address postal code
AddressCountry          | string    | no           | yes           | shipping address country (Canada)
AddressCity             | string    | no           | yes           | shipping address city
