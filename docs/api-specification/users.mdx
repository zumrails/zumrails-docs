...
---------               | -------   | ----  | -------   | ----          | ----          | ----
FirstName               | string    | yes   | yes       | yes           | yes           | User first name. Pattern accepted: ^[^\s]([a-zA-Z0-9àâäèéêëîïôœùûüÿçÀ ÄÈÉÊËÎÏÔŒÙÛÜŸÇ '\-\.,]+)[^\s]$
LastName                | string    | yes   | yes       | yes           | yes           | User last name. Pattern accepted: ^[^\s]([a-zA-Z0-9àâäèéêëîïôœùûüÿçÀ ÄÈÉÊËÎÏÔŒÙÛÜŸÇ '\-\.,]+)[^\s]$
CompanyName             | string    | no    | yes       | yes           | yes           | Company name, in case it's a company. Pattern accepted: ^[^\s]([a-zA-Z0-9àâäèéêëîïôœùûüÿçÀ ÄÈÉÊËÎÏÔŒÙÛÜŸÇ '\-\.,]+)[^\s]$
