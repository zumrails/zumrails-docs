...
Use this endpoint if you want to unarchive a specific product price. Once unarchived, the product price will be visible in any end user facing screens. If there are any active subscriptions or invoices they will remain until unaffected.
