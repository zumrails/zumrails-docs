...
The payload sent by the webhook has the same JSON format for the get [User](./users/#get-a-specific-user) and [Transaction](./transactions/#get-a-specific-transaction).
