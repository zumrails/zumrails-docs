...
![Library authentication](/img/docs/diagrams/flows/flow1.png)
...
![SDK add user flow](/img/docs/diagrams/flows/flow12.png)
...
![SDK add user flow](/img/docs/diagrams/flows/flow17.png)
...
![SDK invoice checkout flow](/img/docs/diagrams/flows/flow13.png)
...
![SDK subscription](/img/docs/diagrams/flows/flow14.png)
...
![SDK manage user](/img/docs/diagrams/flows/flow2.png)

### Cancel subscription using SDK

![SDK manage user](/img/docs/diagrams/flows/flow3.png)
...
![SDK manage user](/img/docs/diagrams/flows/flow17.png)
