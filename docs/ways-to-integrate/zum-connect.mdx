...
displayZumRailsLogo| To display the powered by Zũm Rails logo
...
To listen to the event in js, your website must refer to Zũm Connect using an iFrame, and then your website should have the script/example.
