...
Zum wallet is a virtual account which is used to facilitate money movement from either your bank account to your users’ bank account or the opposite. You can see all activity involving your Zum wallet through the portal. Every Zūm Rails account comes with one Zūm Wallet.
...
For EFT, using the wallet is optional. For Visa Direct and Credit Cards payment methods, the funds are sent to the wallet and will settle in a merchant account at the end of the day.
...
Learn more about Zum wallet [here](https://www.youtube.com/watch?v=fbQ7A2HuI0o)
