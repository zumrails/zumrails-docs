...
Each product has a unique ID which is automatically generated when you create a product. When you create a product in Zūm Rails, you have to provide a name. You can optionally add other attributes, like a description or image. 
...
<ReactPlayer className='react-player'
          controls='true'
          width='100%'
          url='https://www.youtube.com/watch?v=7em4Fla50Y8' />


<br/>

![Create a product flow](/img/docs/diagrams/flows/flow19.png)
